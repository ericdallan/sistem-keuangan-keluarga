        ...
        <form wire:submit="login">
            ...
            <div class="mb-3">
                ...
                <div class="input-group border rounded-3 overflow-hidden shadow-sm">
                    ...
                    <input wire:model="form.email" id="email" type="email" name="email"
                        class="form-control border-0 py-2 @error('form.email') is-invalid @enderror"
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    @if (Route::has('password.request'))
                        <a class="small text-decoration-none fw-bold text-sk-primary"
                            href="{{ route('password.request') }}" wire:navigate>Lupa?</a>
                    @endif
                </div>
                <div class="input-group border rounded-3 overflow-hidden shadow-sm">
                    ...
                    <input wire:model="form.password" id="password" type="password" name="password"
                        class="form-control border-0 py-2 @error('form.password') is-invalid @enderror"
            ...
            <div class="d-grid mb-3">
                <button type="submit" class="btn-sk-primary btn-lg rounded-pill fw-bold py-2 shadow-sm border-0 w-100"
                    ...
                    <span wire:loading.remove>Masuk Sekarang <i class="bi bi-box-arrow-in-right ms-1"></i></span>
                    <span wire:loading>
            ...
            <div class="text-center">
                <a href="/" wire:navigate class="text-muted small text-decoration-none fw-semibold">
